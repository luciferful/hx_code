...
ucidef_set_interface_batnet() {
        uci batch <<EOF
set network.batnet='interface'
set network.batnet.mtu='1532'
set network.batnet.proto='batadv'
set network.batnet.mesh='bat0'
EOF
}
...
set network.lan.ipaddr='192.168.2.2'
set network.lan.netmask='255.255.255.0'
set network.lan.dhcp='off'
set network.lan.startaddr='192.168.2.100'
set network.lan.endaddr='192.168.2.200'
set network.lan.maskaddr='255.255.0.0'
EOF
}
