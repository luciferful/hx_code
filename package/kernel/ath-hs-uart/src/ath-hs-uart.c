...
void ath_hs_uart_init(void)
{
	...
	data = (data & ~GPIO_OUT_FUNCTION2_ENABLE_GPIO_11_MASK) |
		GPIO_OUT_FUNCTION2_ENABLE_GPIO_11_SET(0x4f);
	...
	data = (data & 0xfffff7ff) | 0x1000;
	ath_reg_wr(ATH_GPIO_OE, data);

	// Enabling UART1_RD,UART1_CTS as inputs on GPIO12
	ath_reg_wr(ATH_GPIO_IN_ENABLE9, 0xc0000);
